...
const delete_event_1 = require("./routes/delete-event");
...
const update_event_1 = require("./routes/update-event");
...
app.register(update_event_1.updateEvent);
app.register(delete_event_1.deleteEvent);
